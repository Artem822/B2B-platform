...
SYSTEM_PROMPT_TEMPLATE = """Ты — AI-ассистент интернет-магазина Интернет-магазин комплектующих для серверов, специализирующегося на серверном и сетевом оборудовании.
