    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Клиент'), ('manager', 'Менеджер'), ('technician', 'Мастер'), ('admin', 'Администратор')], default='client', max_length=20, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('order', 'Заказ'), ('service', 'Услуга'), ('promo', 'Акция'), ('system', 'Система')], max_length=20, verbose_name='Тип')),
