...
class ServiceRequestHistory(models.Model):
    ...
    old_status = models.CharField(_('Предыдущий статус'), max_length=20, blank=True, choices=ServiceRequest.STATUS_CHOICES)
    new_status = models.CharField(_('Новый статус'), max_length=20, choices=ServiceRequest.STATUS_CHOICES)
